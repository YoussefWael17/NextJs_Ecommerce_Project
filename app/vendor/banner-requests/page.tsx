...
import { faBullhorn, faFire, faTag, faPercent, faShoePrints, faAppleWhole, faBolt, faStar, faTriangleExclamation, faRotateRight } from "@fortawesome/free-solid-svg-icons";

import { faApple } from "@fortawesome/free-brands-svg-icons";

import { useCreateBannerRequestMutation, useGetProductsQuery } from "@/app/redux/services/vendorsApi";
...
export default function BannerRequestsPage() {
  ...
  const { data, isLoading, isFetching, isError, refetch } = useGetProductsQuery({ search: "" });
  ...
  const [ createBannerRequest, { isLoading: isCreating } ] = useCreateBannerRequestMutation();
  ...
  /* ================================================================
      Icons Available for Banner Requests
  ================================================================ */
  ...
  const handleSubmit = async () => {
    ...
    try {
      await createBannerRequest(requestData).unwrap();

      toast.success(
        "Banner request created successfully."
      );
      ...
      const message =
        error?.data?.message ||
        error?.error ||
        "Failed to create banner request. Please try again.";
    ...
    <div className="space-y-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">
              Request your product to be featured on the homepage banner.
            </p>
          </div>
      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
        ...
        <div className="mb-8">
          ...
          <p className="mt-1 text-sm text-gray-500">
            Select a product and customize how it should appear on the
            homepage banner.
          </p>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <select
                ...
                disabled={isCreating}
                className="w-full appearance-none rounded-xl border border-gray-300 bg-white px-4 py-3 pl-11 text-sm outline-none transition focus:border-[#DB4444] focus:ring-2 focus:ring-red-100 disabled:cursor-not-allowed disabled:bg-gray-50"
              >
                {icons.map((item) => (
                  <option
                    key={item.name}
              ...
              <div className="pointer-events-none absolute left-4 top-1/2 -translate-y-1/2 text-[#DB4444]">
                <FontAwesomeIcon
                  icon={
                    icons.find(
                      (item) => item.name === icon
          ...
          <div className="mb-4 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-gray-500">
                Choose the background color for your banner.
              </p>
            </div>
